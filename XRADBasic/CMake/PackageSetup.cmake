...
if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
	...
	function(xrad_compose_library_name var_name package_name)
		...
		set(${var_name} "${XRAD_BuildDir}/${package_name}/${XRAD_MSVCRelativeBuildDir}${library_name}${LibSuffix}.lib" PARENT_SCOPE)
	endfunction()
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
	...
	function(xrad_compose_library_name var_name package_name)
		...
		set(${var_name} "${XRAD_BuildDir}/${package_name}/lib${library_name}.a" PARENT_SCOPE)
	endfunction()
else()
